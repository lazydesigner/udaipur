<div class="list-of-areas">
    <div class="list-of-areas-row">
        <div class="list-of-areas-col">
            <a href="<?= get_url() ?>chetak-circle/" aria-label="chetak circle">
                <div class="areas-container">
                    <img src="<?= $cdn_url ?>chetak-circle.webp" width="100%" height="100%" alt="chetak circle" loading="lazy">
                </div>
            </a>
        </div>
        <div class="list-of-areas-col">
            <a href="<?= get_url() ?>fateh-sagar/" aria-label="fateh sagar">
                <div class="areas-container">
                    <img src="<?= $cdn_url ?>fateh-sagar.webp" width="100%" height="100%" alt="fateh sagar" loading="lazy">
                </div>
            </a>
        </div>
        <div class="list-of-areas-col">
            <a href="<?= get_url() ?>ghanta-ghar/"   aria-label="ghanta ghar">
                <div class="areas-container">
                    <img src="<?= $cdn_url ?>ghanta-ghar.webp" width="100%" height="100%" alt="ghanta ghar" loading="lazy">
                </div>
            </a>
        </div>
        <div class="list-of-areas-col">
            <a href="<?= get_url() ?>udaipur-bus-stand/" aria-label="udaipur bus stand">
                <div class="areas-container">
                    <img src="<?= $cdn_url ?>udaipur-bus-stand.webp" width="100%" height="100%" alt="udaipur bus stand" loading="lazy">
                </div>
            </a>
        </div>
    </div>
    <div class="list-of-areas-row">
        <div class="list-of-areas-col">
            <a href="<?= get_url() ?>hathipol/" aria-label="hathipol escorts">
                <div class="areas-container">
                    <img src="<?= $cdn_url ?>hathipol.webp" width="100%" height="100%" alt="hathipol escorts" loading="lazy">
                </div>
            </a>
        </div>
        <div class="list-of-areas-col">
            <a href="<?= get_url() ?>call-girls-in-jagdish-chowk/"  aria-label="jagdish chowk  escorts">
                <div class="areas-container">
                    <img src="<?= $cdn_url ?>jagdish-chowk.webp" width="100%" height="100%" alt="amjagdish chowk escorts" loading="lazy">
                </div>
            </a>
        </div>
        <div class="list-of-areas-col">
            <a href="<?= get_url() ?>jawahar-nagar/" aria-label="jawahar nagar escorts">
                <div class="areas-container">
                    <img src="<?= $cdn_url ?>jawahar-nagar.webp" width="100%" height="100%" alt="jawahar nagar escorts" loading="lazy">
                </div>
            </a>
        </div>
        <div class="list-of-areas-col">
            <a href="<?= get_url() ?>sukhadia-circle/" aria-label="sukhadia circle escorts">
                <div class="areas-container">
                    <img src="<?= $cdn_url ?>sukhadia-circle.webp" width="100%" height="100%" alt="sukhadia circle escorts" loading="lazy">
                </div>
            </a>
        </div>
    </div>
    <div class="list-of-areas-row">
        <div class="list-of-areas-col">
            <a href="<?= get_url() ?>lal-ghat/"  aria-label="lalghat escorts">
                <div class="areas-container">
                    <img src="<?= $cdn_url ?>lalghat.webp" width="100%" height="100%" alt="lalghat escorts" loading="lazy">
                </div>
            </a>
        </div>
        <div class="list-of-areas-col">
            <a href="<?= get_url() ?>panchwati/"  aria-label="panchwati">
                <div class="areas-container">
                    <img src="<?= $cdn_url ?>panchwati.webp" width="100%" height="100%" alt="panchwati" loading="lazy">
                </div>
            </a>
        </div>
        <div class="list-of-areas-col">
            <a href="<?= get_url() ?>pratap-nagar/" aria-label="pratap nagar escorts">
                <div class="areas-container">
                    <img src="<?= $cdn_url ?>pratap-nagar.webp" width="100%" height="100%" alt="pratap nagar escorts" loading="lazy">
                </div>
            </a>
        </div>
        <div class="list-of-areas-col">
            <a href="<?= get_url() ?>sabina/" aria-label="sabina escorts">
                <div class="areas-container">
                    <img src="<?= $cdn_url ?>sabina.webp" width="100%" height="100%" alt="sabina escorts" loading="lazy">
                </div>
            </a>
        </div>
    </div>
...
<div class="service-information">
    <div class="service-info-row">
        <div class="service-info-col">
            <div class="service-info-col-icon">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="rgba(255,255,0,1)">
                    <path d="M17.841 15.659L18.017 15.836L18.1945 15.659C19.0732 14.7803 20.4978 14.7803 21.3765 15.659C22.2552 16.5377 22.2552 17.9623 21.3765 18.841L18.0178 22.1997L14.659 18.841C13.7803 17.9623 13.7803 16.5377 14.659 15.659C15.5377 14.7803 16.9623 14.7803 17.841 15.659ZM12 14V22H4C4 17.6651 7.44784 14.1355 11.7508 14.0038L12 14ZM12 1C15.315 1 18 3.685 18 7C18 10.315 15.315 13 12 13C8.685 13 6 10.315 6 7C6 3.685 8.685 1 12 1Z"></path>
                </svg>
            </div>
            <div class="service-info-col-detail">
                <strong>100% Satisfaction</strong>
                <p>Customer Satisfaction Gauranteed</p>
            </div>
        </div>
        <div class="service-info-col">
            <div class="service-info-col-icon">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="rgba(255,232,0,1)">
            ...
            <div class="service-info-col-detail">
                <strong>24X7 Call Girl Service</strong>
                <p>Escorts service in Goa 24X7 Available</p>
            </div>
        </div>
        <div class="service-info-col">
            <div class="service-info-col-icon">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="rgba(255,230,0,1)">
...
<script>
    setTimeout(function() {
        ...
        // Show the delayed content
        var delayedContent = document.getElementById("backb");
